...
SELECT id, account, email, full_name, gender_id, cellphone, address, shipping_address, post_code, hashed_password, status, avatar_url, password_changed_at, created_at, is_email_verified FROM users
WHERE id = $1 LIMIT 1
`
